...
export type AITask = 'create_node' | 'plan_scene' | 'compose_scene' | 'diff_scene';
...
export type AIRequest = CreateNodeRequest | PlanSceneRequest | ComposeSceneRequest | DiffSceneRequest;
