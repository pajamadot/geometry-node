...
async def add_job(request: Request, background_tasks: BackgroundTasks):
  """
  ...
  background_tasks.add_task(run_agent_flow, request_data)

  return { "job_id": job_id }


@router.get("/assistant/stream/{job_id}")
async def get_job_stream(request: Request, job_id: str):
